...
const Cart = () => {
    ...
    useEffect(()=>{
        ...
        setCartItems(data);
        let sum = data.reduce((sum , v , i, a)=>{return sum + v.price *v.quantity} , 0);
        setCartPrice(sum);
    } , [])
    ...
    //             <img src="https://cdn.grofers.com/assets/ui/empty_states/emp_empty_cart.png" alt="" width="500px" height="500px" />
    ...
    //         <h1>Total Cart Price : {cartPrice}</h1>
